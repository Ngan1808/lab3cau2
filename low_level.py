...
from mininet.link import Link		
 ...
 h4.setIP( '10.0.0.6/24' )
 h4.setIP( '10.0.0.7/24' )
 h4.setIP( '10.0.0.8/24' )		
 c1.start()		
 a1.start( [ c1 ] )		
 a2.start( [ c1 ] )		
 print h1.IP		
 ...
 print h2.cmd( 'ping -c3 ', h3.IP() )	
 print h2.cmd( 'ping -c3 ', h4.IP() )
 print h2.cmd( 'ping -c3 ', h5.IP() )	
 print h2.cmd( 'ping -c3 ', h6.IP() )	
 print h2.cmd( 'ping -c3 ', h7.IP() )	
 print h2.cmd( 'ping -c3 ', h8.IP() )	
 print h3.cmd( 'ping -c3 ', h4.IP() )	
 print h3.cmd( 'ping -c3 ', h5.IP() )	
 print h3.cmd( 'ping -c3 ', h6.IP() )	
 print h3.cmd( 'ping -c3 ', h7.IP() )	
 print h3.cmd( 'ping -c3 ', h8.IP() )	
 print h4.cmd( 'ping -c3 ', h5.IP() )	
 print h4.cmd( 'ping -c3 ', h6.IP() )	
 print h4.cmd( 'ping -c3 ', h7.IP() )	
 print h4.cmd( 'ping -c3 ', h8.IP() )	
 print h5.cmd( 'ping -c3 ', h6.IP() )	
 print h5.cmd( 'ping -c3 ', h7.IP() )	
 print h5.cmd( 'ping -c3 ', h8.IP() )	
 print h6.cmd( 'ping -c3 ', h7.IP() )	
